...
public class QuestionAnswerServiceImpl implements IQuestionAnswerService 
{
    ...
    @Override
    public int selectQuestionAnswer(String names, String type) {
    ...
    @Override
    public int selectQuestionhappySAnswer(String names, String type) {
        Long name = Long.parseLong(names);
        return questionAnswerMapper.selectQuestionhappySAnswer(name,type);
    }
    ...
    @Override
    public int selectAnswers(String names, String type, Integer integer) {
        Long name = Long.parseLong(names);
        return questionAnswerMapper.selectQuestionAnswers1(name,type,integer);
    }
