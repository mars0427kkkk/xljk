...
import com.ruoyi.common.exception.wxmpsms.MpsException;
import com.ruoyi.common.utils.SecurityUtils;
import com.ruoyi.framework.security.wx.WxCodeAuthenticationToken;
...
//            log.info("微信用户不存在,注册中...");
    ...
    public AjaxResult updatePhoneByOpenid(String phoneNumber, String openid) {
        SysUser sysUser = userService.selectUserByOpenid(openid);
        sysUser.setPhonenumber(phoneNumber);
        userService.updateUser(sysUser);
        AjaxResult ajax = AjaxResult.success();
        ajax.put("wxxUser", sysUser);
        return ajax;
    }
}
